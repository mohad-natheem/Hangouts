...
val ColorScheme = darkColorScheme(
    ...
    surfaceContainerLowest = HangoutsSurfaceContainerLowest,
    surfaceContainerLow = HangoutsSurfaceContainerLow,
    surfaceContainer = HangoutsSurfaceContainer,
    surfaceContainerHigh = HangoutsSurfaceContainerHigh,
    surfaceContainerHighest = HangoutsSurfaceContainerHighest,
